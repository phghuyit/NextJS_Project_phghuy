    ...
    <div className="mb-12">
      ...
      <div className="m-6 flex items-center justify-between">
        ...
        <div className="flex gap-4">
          <Link href="/admin/brands/create" className="rounded-md bg-blue-500 px-4 py-2 font-bold text-white transition-colors hover:bg-blue-600 shadow-sm">
            Tạo tác giả mới
          </Link>
          <Link href="/admin/brands/trash" className="rounded-md bg-red-500 px-4 py-2 font-bold text-white transition-colors hover:bg-red-600 shadow-sm">
            Thùng rác
          </Link>
        </div>
      </div>
