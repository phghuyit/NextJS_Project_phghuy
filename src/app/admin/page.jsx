  ...
  return (
    <div id="page-dashboard" className="page active">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 m-6">
          ...
          <div className="cursor-pointer rounded-2xl bg-white border border-gray-200 p-5 text-[#131921] transition duration-300 hover:border-orange-400 hover:bg-orange-50 hover:text-orange-500">
