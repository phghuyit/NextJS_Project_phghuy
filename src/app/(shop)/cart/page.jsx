...
export default function Page() {
  ...
  return (
    <main className="py-8 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-[#0f1111]">
      <div className="flex flex-col gap-8 lg:flex-row lg:items-start">
        <div className="flex-[3] bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="flex-1 w-full lg:w-auto bg-white p-6 rounded-lg shadow-sm border border-gray-200 sticky top-24">
          ...
          <div className="w-full">
            <Link href="/checkout" className="block rounded-lg text-center my-3 whitespace-nowrap bg-orange-400 hover:bg-orange-500 transition-colors duration-300 p-3">
